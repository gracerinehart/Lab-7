...
**Figure 5: Predicted death rate based on gun ownership % in top 5
states.**
...
**Figure 6: Observed death rate based on gun ownership % in all
states.**
...
**Figure 7: Predicted death rate values using household ownership %
