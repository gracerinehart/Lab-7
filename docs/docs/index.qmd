...
Review. Our data from the Centers for Disease Control and & Prevention
...
within our desired data which showed that the null hypothesis was not
...
Based on this, linear regression was used to test for a relationship
